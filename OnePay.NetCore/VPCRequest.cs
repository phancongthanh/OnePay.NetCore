...
namespace OnePay.NetCore
{
    public class VPCRequest
    {
        ...
        public void AddDigitalOrderField(string key, string value)
        {
            ...
            if (_requestFields.ContainsKey(key)) _requestFields[key] = value;
            else _requestFields.Add(key, value);
        }
        ...
        {
            return _responseFields.ToDictionary(x => x.Key, x => x.Value);
        }
        ...
        public string CreateSHA256Signature(bool useRequest)
        {
            ...
            {
                convertedHash[i] = (byte)int.Parse(_secureSecret.Substring(i * 2, 2), NumberStyles.HexNumber);
            }
